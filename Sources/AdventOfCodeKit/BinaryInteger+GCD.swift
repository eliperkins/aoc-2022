extension BinaryInteger {
    public static func gcd(_ xs: [Self]) -> Self {
        xs.reduce(0, AdventOfCodeKit.gcd)
    }

    public static func lcm(_ a: Self, _ b: Self) -> Self {
        a * b / AdventOfCodeKit.gcd(a, b)
    }
...
// https://github.com/apple/swift-numerics/blob/5428505255ad35b8debd2c2c432350b213e4dff5/Sources/IntegerUtilities/GCD.swift
// ===--- GCD.swift --------------------------------------------*- swift -*-=== //
//
